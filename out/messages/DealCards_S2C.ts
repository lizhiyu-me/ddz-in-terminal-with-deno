...
export declare namespace $ {
  export type DealCards_S2C = {
    cards: number[];
    seatNumber: number;
  }
}

export type Type = $.DealCards_S2C;

export function getDefaultValue(): $.DealCards_S2C {
  return {
    cards: [],
    seatNumber: 0,
  };
...
export function createValue(partialValue: Partial<$.DealCards_S2C>): $.DealCards_S2C {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.DealCards_S2C): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.DealCards_S2C {
...
export function encodeBinary(value: $.DealCards_S2C): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.DealCards_S2C {
  const result = getDefaultValue();
