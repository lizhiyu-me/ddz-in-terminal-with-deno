...
export declare namespace $ {
  export type PlayCards_C2S = {
    cards: number[];
    seatNumber: number;
  }
}

export type Type = $.PlayCards_C2S;

export function getDefaultValue(): $.PlayCards_C2S {
  return {
    cards: [],
    seatNumber: 0,
  };
...
export function createValue(partialValue: Partial<$.PlayCards_C2S>): $.PlayCards_C2S {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.PlayCards_C2S): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.PlayCards_C2S {
...
export function encodeBinary(value: $.PlayCards_C2S): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.PlayCards_C2S {
  const result = getDefaultValue();
